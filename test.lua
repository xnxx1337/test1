...
-- library init
	...
	writefile("ffff.ttf", game:HttpGet("https://github.com/xnxx1337/test1/raw/refs/heads/main/fs-tahoma-8px.ttf"))
		...
		function library:window(properties)
			...
			-- main window
				local main_window = library:panel({
					name = properties and properties.name or "Easy-Cheat | ", 
			...
			-- theming 
				...
				local watermark = library:watermark({default = os.date('Easy-Cheat |  - %b %d %Y - %H:%M:%S')})  

				task.spawn(function()
					while task.wait(1) do 
						watermark.change_text(os.date('Easy-Cheat - Beta - %b %d %Y - %H:%M:%S'))
					end 
				end) 
